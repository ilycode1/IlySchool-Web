...
export const metadata = {
  ...
  description: `Syarat dan ketentuan penggunaan layanan ${BRAND_NAME} — platform website sekolah profesional Indonesia.`,
  robots: { index: false, follow: true },
  alternates: {
    canonical: `https://${BRAND_DOMAIN}/syarat-ketentuan`,
  },
}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <Section title="1. Definisi">
          <ul className="space-y-2">
            <li>
              <strong>&quot;{BRAND_NAME}&quot;</strong> merujuk pada platform
              dan layanan website sekolah yang dioperasikan oleh IlyCode
              Softwarelabs.
            </li>
            <li>
              <strong>&quot;Pengguna&quot;</strong> merujuk pada pihak yang
              menggunakan layanan {BRAND_NAME}, dalam hal ini institusi sekolah
              atau perwakilannya.
            </li>
            <li>
              <strong>&quot;Layanan&quot;</strong> merujuk pada pembuatan,
              pengelolaan, dan hosting website sekolah yang disediakan oleh{' '}
              {BRAND_NAME}.
            </li>
            <li>
              <strong>&quot;Konten&quot;</strong> merujuk pada semua materi
              yang dikirimkan Pengguna kepada kami, termasuk teks, gambar,
              logo, dan dokumen.
            </li>
          </ul>
        </Section>
        ...
        <Section title="3. Paket Layanan dan Pembayaran">
          <p>
            {BRAND_NAME} menawarkan beberapa paket layanan dengan harga yang
            tertera di halaman resmi. Harga dapat berubah sewaktu-waktu dengan
            pemberitahuan terlebih dahulu.
          </p>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>Pembayaran dilakukan di muka sebelum pengerjaan dimulai</li>
            <li>
              Masa aktif langganan dihitung sejak tanggal website di-
              <em>launch</em>
            </li>
            <li>Perpanjangan layanan dilakukan sebelum masa aktif berakhir</li>
            <li>
              Harga promo berlaku selama stok/kuota tersedia dan dapat berakhir
              tanpa pemberitahuan
            </li>
          </ul>
        </Section>
        ...
        <Section title="4. Kebijakan Pengembalian Dana">
          <p>
            Mengingat sifat layanan kami yang berbasis jasa digital,
            pengembalian dana (refund) hanya dapat dilakukan dalam kondisi
            berikut:
          </p>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>
              Website belum mulai dikerjakan dan permintaan pembatalan diajukan
              dalam 24 jam setelah pembayaran
            </li>
            <li>
              Terjadi kegagalan teknis dari pihak kami yang mengakibatkan
              website tidak dapat di-<em>launch</em>
            </li>
          </ul>
          <p className="mt-3">
            Setelah proses pengerjaan dimulai, pembayaran tidak dapat
            dikembalikan. Kami berkomitmen menyelesaikan website sesuai dengan
            brief yang telah disepakati.
          </p>
        </Section>

        <Section title="5. Hak Kekayaan Intelektual">
          <p>
            Konten yang dikirimkan oleh Pengguna (logo, foto, teks sekolah)
            tetap menjadi milik Pengguna. Dengan mengirimkan konten, Pengguna
            memberikan izin kepada {BRAND_NAME} untuk menggunakan konten
            tersebut semata-mata untuk keperluan membangun dan mengelola website
            sekolah.
          </p>
          <p>
            Template desain, kode, dan aset visual yang dibuat oleh{' '}
            {BRAND_NAME} adalah milik IlyCode Softwarelabs. Pengguna mendapatkan
            lisensi penggunaan selama masa aktif berlangganan.
          </p>
        </Section>

        <Section title="6. Tanggung Jawab Konten">
          <p>
            Pengguna bertanggung jawab penuh atas konten yang dikirimkan dan
            dipublikasikan di website sekolah, termasuk memastikan bahwa konten
            tersebut:
          </p>
          <ul className="list-disc list-inside space-y-1 mt-2">
          ...
          <p className="mt-3">
            {BRAND_NAME} berhak menolak atau menghapus konten yang melanggar
        ...
        <Section title="7. Uptime dan Ketersediaan Layanan">
          <p>
            Kami berkomitmen menjaga website sekolah Anda tetap online dengan
            target uptime 99,5% per tahun. Namun, {BRAND_NAME} tidak bertanggung
            jawab atas downtime yang disebabkan oleh:
          </p>
          <ul className="list-disc list-inside space-y-1 mt-2">
        ...
        <Section title="8. Penghentian Layanan">
          <p>{BRAND_NAME} berhak menghentikan layanan kepada Pengguna jika:</p>
          <ul className="list-disc list-inside space-y-1 mt-2">
        ...
        <Section title="9. Batasan Tanggung Jawab">
          <p>
            Sejauh diizinkan oleh hukum yang berlaku, {BRAND_NAME} dan IlyCode
            Softwarelabs tidak bertanggung jawab atas kerugian tidak langsung,
        ...
        <Section title="10. Perubahan Syarat & Ketentuan">
          <p>
            ...
            Perubahan signifikan akan diinformasikan minimal 14 hari sebelum
            berlaku melalui email terdaftar atau pemberitahuan di website.
          </p>
        </Section>
