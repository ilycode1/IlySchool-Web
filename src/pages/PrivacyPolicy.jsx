...
const PrivacyPolicy = () => (
  <>
    <Helmet>
      <title>Kebijakan Privasi | {BRAND_NAME}</title>
      <meta
        name="description"
        content={`Kebijakan privasi ${BRAND_NAME} — bagaimana kami mengumpulkan, menggunakan, dan melindungi data Anda.`}
      />
      <meta name="robots" content="noindex, follow" />
      <link rel="canonical" href={`https://${BRAND_DOMAIN}/kebijakan-privasi`} />
    </Helmet>
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-10 text-sm text-amber-800 leading-relaxed">
        Dengan menggunakan layanan {BRAND_NAME}, Anda menyetujui kebijakan privasi ini.
      ...
      <Section title="1. Informasi yang Kami Kumpulkan">
        ...
        <ul className="list-disc list-inside space-y-1 mt-2">
          ...
          <li>Konten yang Anda kirimkan untuk website sekolah (logo, foto, teks, dll)</li>
        </ul>
        <p className="mt-3">
          Selain itu, kami secara otomatis mengumpulkan informasi teknis seperti alamat IP,
          jenis browser, dan halaman yang dikunjungi untuk keperluan analitik dan keamanan.
        </p>
      </Section>
      ...
      <Section title="2. Bagaimana Kami Menggunakan Informasi Anda">
        ...
        <ul className="list-disc list-inside space-y-1 mt-2">
          ...
          <li>Mengirimkan informasi terkait layanan baru (hanya jika Anda menyetujui)</li>
      ...
      <Section title="3. Berbagi Informasi dengan Pihak Ketiga">
        <p>
          Kami <strong>tidak menjual, menyewakan, atau membagikan</strong> data pribadi Anda
          kepada pihak ketiga untuk tujuan pemasaran tanpa persetujuan eksplisit Anda.
        </p>
        <p>
          Informasi dapat dibagikan kepada pihak ketiga hanya dalam kondisi berikut:
        </p>
        <ul className="list-disc list-inside space-y-1 mt-2">
      ...
      <Section title="4. Keamanan Data">
        <p>
          ...
          melindungi informasi Anda dari akses, pengungkapan, atau penghancuran yang tidak
          sah, termasuk enkripsi SSL/TLS pada seluruh komunikasi data.
        </p>
        <p>
          Namun, tidak ada metode transmisi data melalui internet yang 100% aman. Kami tidak
          dapat menjamin keamanan absolut dari informasi yang ditransmisikan kepada kami.
        </p>
      </Section>

      <Section title="5. Penyimpanan Data">
        <p>
          Data Anda disimpan selama masa aktif berlangganan layanan {BRAND_NAME}. Jika Anda
          tidak memperpanjang langganan, data akan disimpan selama 30 hari sebelum dihapus
          secara permanen, kecuali diwajibkan oleh hukum untuk disimpan lebih lama.
        </p>
      </Section>
      ...
      <Section title="7. Cookie dan Pelacakan">
        <p>
          Website kami menggunakan cookie untuk meningkatkan pengalaman pengguna dan
          menganalisis trafik. Anda dapat mengatur browser untuk menolak cookie, namun
      ...
      <Section title="8. Perubahan Kebijakan">
        <p>
          ...
          akan diinformasikan melalui email atau pemberitahuan di website kami. Penggunaan
          layanan setelah perubahan berarti Anda menyetujui kebijakan yang diperbarui.
        </p>
      </Section>
